...
>
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
    ...
    <h2 className="text-4xl pt-10 md:text-5xl font-bold text-white">About <span className="break-normal bg-gradient-to-r from-[#ff7eb9] via-[#9429db] to-[#4f2ba3] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-x">Me</span></h2>
  ...
  <div className="transition duration-300 ease-in-out hover:shadow-[0_0_15px_#d498fb] hover:border-[#d498fb] inline-flex items-center gap-1 sm:gap-2 border border-[#b49bff] bg-opacity-90 rounded-full px-2 py-0.5 sm:px-3 sm:py-1">
    <GiGraduateCap className="text-[#b49bff] h-3 w-3 sm:h-4 sm:w-4" />
    <span className="text-xs sm:text-sm font-semibold text-[#d498fb] whitespace-nowrap">
  ...
  <a
    href="#contact"
    className="text-sm w-fit bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-500 text-white font-semibold py-2 px-4 rounded-full border border-purple-400 hover:shadow-[0_0_25px_#cbaaff] transition duration-300"
  >
    Get In Touch
  </a>
  <a
    href=""
    className="text-sm w-fit bg-transparent text-white font-semibold py-2 px-4 rounded-full border border-purple-400 hover:bg-gradient-to-r hover:from-[#3d2b7d] hover:to-[#5f2da8] hover:shadow-[0_0_25px_#b49bff] transition duration-300"
  >
    Download CV
  </a>
</div>
